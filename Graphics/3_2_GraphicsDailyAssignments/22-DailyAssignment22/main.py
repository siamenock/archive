...
def log (R):
    th = np.arccos((R[1][1] + R[2][2] + R[0][0] -1)/2)
    sin= np.sin(th);
...
def interpolateRotVec(v1, v2, t):
    return exp(lerp(v1, v2, t))

def interpolateZYXEuler(e1, e2, t):
    return ZYXEulerToRotMat(lerp(e1, e2, t))
